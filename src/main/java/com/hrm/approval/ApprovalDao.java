...
public interface ApprovalDao {
	@Insert("insert into approval (appnum, num, userid, path, name, startdate, enddate, approval_1, approval_2, approval_3, status_1, status_2 ,status_3) values"
	         + "(#{appnum}, #{num}, #{userid}, #{path}, #{name}, #{startdate}, #{enddate}, #{approval_1}, #{approval_2}, #{approval_3}, #{status_1}, #{status_2}, #{status_3})")
	...
	@Select("SELECT a.appnum, a.num, t.atype AS at, a.startdate, a.enddate, a.userid, "
